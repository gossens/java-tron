 ...
 * @since 01.06.2014
 */
public class DataWord implements Comparable<org.tron.common.runtime.vm.DataWord> {
    ...
    // TODO not safe
    public static final org.tron.common.runtime.vm.DataWord ZERO = new org.tron.common.runtime.vm.DataWord(new byte[32]);      // don't push it in to the stack

    public static org.tron.common.runtime.vm.DataWord ONE() {
        return org.tron.common.runtime.vm.DataWord.of((byte)1);
    }
    public static org.tron.common.runtime.vm.DataWord ZERO() {
        return new org.tron.common.runtime.vm.DataWord(new byte[32]);
    }
    ...
    public static org.tron.common.runtime.vm.DataWord of(byte num) {
        byte[] bb = new byte[WORD_SIZE];
        bb[31] = num;
        return new org.tron.common.runtime.vm.DataWord(bb);
    ...
    public org.tron.common.runtime.vm.DataWord and(org.tron.common.runtime.vm.DataWord w2) {
    ...
    public org.tron.common.runtime.vm.DataWord or(org.tron.common.runtime.vm.DataWord w2) {
    ...
    public org.tron.common.runtime.vm.DataWord xor(org.tron.common.runtime.vm.DataWord w2) {
    ...
    public void negate() {
        ...
        bnot();
        add(org.tron.common.runtime.vm.DataWord.ONE());
    }
    ...
    public void add(org.tron.common.runtime.vm.DataWord word) {
    ...
    public void add2(org.tron.common.runtime.vm.DataWord word) {
    ...
    public void mul(org.tron.common.runtime.vm.DataWord word) {
        BigInteger result = value().multiply(word.value());
        this.data = ByteUtil.copyToArray(result.and(MAX_VALUE));
    }

    // TODO: improve with no BigInteger
    public void div(org.tron.common.runtime.vm.DataWord word) {
    ...
    // TODO: improve with no BigInteger
    public void sDiv(org.tron.common.runtime.vm.DataWord word) {
    ...
    // TODO: improve with no BigInteger
    public void sub(org.tron.common.runtime.vm.DataWord word) {
        BigInteger result = value().subtract(word.value());
        this.data = ByteUtil.copyToArray(result.and(MAX_VALUE));
    }

    // TODO: improve with no BigInteger
    public void exp(org.tron.common.runtime.vm.DataWord word) {
        BigInteger result = value().modPow(word.value(), _2_256);
        this.data = ByteUtil.copyToArray(result);
    }

    // TODO: improve with no BigInteger
    public void mod(org.tron.common.runtime.vm.DataWord word) {
    ...
    public void sMod(org.tron.common.runtime.vm.DataWord word) {
    ...
    public void addmod(org.tron.common.runtime.vm.DataWord word1, org.tron.common.runtime.vm.DataWord word2) {
        if (word2.isZero()) {
    ...
    public void mulmod(org.tron.common.runtime.vm.DataWord word1, org.tron.common.runtime.vm.DataWord word2) {
    ...
    public org.tron.common.runtime.vm.DataWord clone() {
        return new org.tron.common.runtime.vm.DataWord(Arrays.clone(data));
    }
    ...
    public boolean equals(Object o) {
        ...
        org.tron.common.runtime.vm.DataWord dataWord = (org.tron.common.runtime.vm.DataWord) o;
    ...
    @Override
    public int compareTo(org.tron.common.runtime.vm.DataWord o) {
     ...
     * @return this << arg
     */
    public org.tron.common.runtime.vm.DataWord shiftLeft(org.tron.common.runtime.vm.DataWord arg) {
        if (arg.value().compareTo(BigInteger.valueOf(MAX_POW)) >= 0) {
            return org.tron.common.runtime.vm.DataWord.ZERO();
        }

        BigInteger result = value().shiftLeft(arg.intValueSafe());
        return new org.tron.common.runtime.vm.DataWord(ByteUtil.copyToArray(result.and(MAX_VALUE)));
    }
     ...
     * @return this >> arg
     */
    public org.tron.common.runtime.vm.DataWord shiftRight(org.tron.common.runtime.vm.DataWord arg) {
        if (arg.value().compareTo(BigInteger.valueOf(MAX_POW)) >= 0) {
            return org.tron.common.runtime.vm.DataWord.ZERO();
        }
     ...
     * @return this >> arg
     */
    public org.tron.common.runtime.vm.DataWord shiftRightSigned(org.tron.common.runtime.vm.DataWord arg) {
        if (arg.value().compareTo(BigInteger.valueOf(MAX_POW)) >= 0) {
            if (this.isNegative()) {
                org.tron.common.runtime.vm.DataWord result = ONE();
                result.negate();
                return result;
            } else {
                return ZERO();
    ...
    public static org.tron.common.runtime.vm.DataWord[] parseArray(byte[] data) {
        int len = data.length / WORD_SIZE;
        org.tron.common.runtime.vm.DataWord[] words = new org.tron.common.runtime.vm.DataWord[len];
        for (int i = 0; i < len; i++) {
            byte[] bytes = Arrays.copyOfRange(data, i * WORD_SIZE, (i + 1) * WORD_SIZE);
            words[i] = new org.tron.common.runtime.vm.DataWord(bytes);
        }
        return words;
    }
}
